...
all_set=set([i for i in range(10**3,10**4) if any([triangular_check(i),square_check(i),pentagonal_check(i),hexagonal_check(i),heptagonal_check(i),octagonal_check(i)])])
listoflists=[]
